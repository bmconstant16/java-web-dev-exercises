...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Fudge Sauce", .50, new ArrayList<>(Arrays.asList("caffeine")));
        Topping topping2 = new Topping("Chopped peanuts", .15, new ArrayList<>(Arrays.asList("peanuts, sunflower oil")));
        Topping topping3 = new Topping("Whipped cream", .00, new ArrayList<>(Arrays.asList("dairy")));
